...
export async function run(harness: Harness): Promise<SmokeOutcome> {
  ...
  const startedOk =
    ...
    initial.stageScroll?.mode === 'vertical' && initial.stageScroll.fireX === 0 && initial.stageScroll.fireY === -1 && initial.stageScroll.outcome === 'playing';
  ...
  evidence.moved = { playerX: moved.playerX, from: initial.stageScroll!.playerX, offset: moved.offset };
  const moveOk = moved.playerX > initial.stageScroll!.playerX + 8;
