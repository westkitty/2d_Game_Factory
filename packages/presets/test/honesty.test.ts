...
describe('required knownLimitations (MASTER_PROJECT.md section 12)', () => {
  const cases: ReadonlyArray<{ id: string; pattern: RegExp }> = [
    ...
    { id: 'horizontal-shmup', pattern: /bullet-pattern choreography/ },
    { id: 'vertical-shmup', pattern: /bullet-pattern choreography/ },
    { id: 'bullet-hell', pattern: /bullet-pattern choreography/ },
