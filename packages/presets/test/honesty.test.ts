...
describe('required knownLimitations (MASTER_PROJECT.md section 12)', () => {
  const cases: ReadonlyArray<{ id: string; pattern: RegExp }> = [
    ...
    { id: 'rhythm-action', pattern: /Charts are judged against an audio transport the game supplies/ },
    { id: 'reaction-timing', pattern: /the seeded reaction state machine are reusable/ },
