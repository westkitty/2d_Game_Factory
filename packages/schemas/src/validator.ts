...
import lootTablesSchema from '../schemas/loot-tables.schema.json' with { type: 'json' };
import chestTypesSchema from '../schemas/chest-types.schema.json' with { type: 'json' };
...
const SCHEMA_DOCUMENTS: Readonly<Record<SchemaName, SchemaDocument>> = {
  ...
  'loot-tables': lootTablesSchema,
  'chest-types': chestTypesSchema,
};
