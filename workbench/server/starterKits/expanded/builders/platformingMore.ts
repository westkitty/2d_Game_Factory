...
export function additionalPlatformStarterKit(variant: AdditionalPlatformStarterVariant) {
  ...
  if (variant === 'endless-runner') return defineExpandedKit({ ...common, presetId: variant, level: { solids: ground, entities: [baseSpawn, { id: 3, class: 'Collectible', name: 'Score', x: 260, y: 450, width: 18, height: 18, properties: [prop('itemId', 'string', 'score'), prop('value', 'int', 10)] }, { id: 4, class: 'Hazard', name: 'Jump Me', x: 525, y: 488, width: 28, height: 12, properties: [prop('damage', 'int', 1)] }] }, tuning: { moveSpeed: 170, jumpVelocity: 460, gravity: 1000 } });
