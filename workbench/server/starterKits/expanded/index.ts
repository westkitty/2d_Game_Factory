...
import { starterKit as aquariumTerrarium } from './aquarium-terrarium.ts';
...
import { starterKit as colonyLite } from './colony-lite.ts';
...
import { starterKit as escapeRoom } from './escape-room.ts';
...
import { starterKit as farmingLite } from './farming-lite.ts';
...
import { starterKit as interactiveFictionHybrid } from './interactive-fiction-hybrid.ts';
import { starterKit as investigationGame } from './investigation-game.ts';
...
import { starterKit as petCreature } from './pet-creature.ts';
...
import { starterKit as pointAndClick } from './point-and-click.ts';
...
import { starterKit as restaurant } from './restaurant.ts';
...
export const EXPANDED_STARTER_KITS: readonly StarterKit[] = Object.freeze([
  ...
  virtualPet,
  photographyGame,
  // P3-J: Simulation management kits promoted after the candidate matrix passed.
  aquariumTerrarium,
  colonyLite,
  farmingLite,
  petCreature,
