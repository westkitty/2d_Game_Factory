 ...
 * `npm run sw2d -- add-theme proof-traditional-platformer <theme-id>`. Every generated game
 ...
 * add more with `npm run sw2d -- add-level proof-traditional-platformer <level-id>`.
 */
