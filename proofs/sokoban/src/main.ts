...
const runtime = await createGame({
  ...
  packs: [combatPack, aiPack, worldPack, entityRegistryPack, progressionPack, arcadePack, puzzleRulesPack, simulationPack, narrativePack, strategyPack, GAME_SPECIFIC_PACK],
