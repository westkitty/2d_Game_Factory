 ...
 * `npm run sw2d -- add-theme proof-microgame-collection <theme-id>`. Every generated game
 ...
 * add more with `npm run sw2d -- add-level proof-microgame-collection <level-id>`.
 */
