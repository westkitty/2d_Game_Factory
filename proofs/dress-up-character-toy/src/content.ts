 ...
 * `npm run sw2d -- add-theme proof-dress-up-character-toy <theme-id>`. Every generated game
 ...
 * add more with `npm run sw2d -- add-level proof-dress-up-character-toy <level-id>`.
 */
