 ...
 * `npm run sw2d -- add-theme proof-falling-block-puzzle <theme-id>`. Every generated game
 ...
 * add more with `npm run sw2d -- add-level proof-falling-block-puzzle <level-id>`.
 */
