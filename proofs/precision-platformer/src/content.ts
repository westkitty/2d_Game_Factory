 ...
 * `npm run sw2d -- add-theme proof-precision-platformer <theme-id>`. Every generated game
 ...
 * add more with `npm run sw2d -- add-level proof-precision-platformer <level-id>`.
 */
