...
describe('precision-platformer content', () => {
  ...
  it('content/climbing.json validates against the climbing-config schema', () => {
  ...
  it('rejects malformed climbing document', () => {
    const malformed = { ...climbingData, wallSlideMaxSpeed: -50 };
