 ...
 *
 * `content/players.json` is the Phase 15 document: authoring it is what opts this
 * game into the `input.players` local-multiplayer routing capability
 * (`urn:sw2d:schema:content-players:v1`). A game that omits it keeps the ordinary
 * single global `ActionInput` and gets no hub at all.
 */
