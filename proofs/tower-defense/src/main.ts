...
const runtime = await createGame({
  ...
  packs: [combatPack, aiPack, worldPack, entityRegistryPack, progressionPack, arcadePack, puzzlePack, simulationPack, narrativePack, strategyPack, navigationPack, itemsPack, weaponsPack, defensePack, autoCombatPack, farmingPack, constructionPack, GAME_SPECIFIC_PACK],
