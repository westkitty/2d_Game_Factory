...
import microgamesData from '../content/microgames.json' with { type: 'json' };
import fishingData from '../content/fishing.json' with { type: 'json' };
import cookingData from '../content/cooking.json' with { type: 'json' };
 ...
 * `npm run sw2d -- add-theme proof-interactive-fiction-hybrid <theme-id>`. Every generated game
 ...
 * add more with `npm run sw2d -- add-level proof-interactive-fiction-hybrid <level-id>`.
 */
